...
const sampleTickets: Ticket[] = [
    ...
    },
    {
      ...
      description: "I've tried to reset my password multiple times, but I'm not receiving the reset email. Can you help?",
      status: "resolved",
    ...
    <div>
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <div>
          ...
          <TicketList tickets={sampleTickets} isAdmin={false}/>
        </div>
      </div>
    </div>
  );
